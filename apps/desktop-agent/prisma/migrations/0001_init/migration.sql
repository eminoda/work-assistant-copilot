...
CREATE UNIQUE INDEX "CredentialMetadata_key_key" ON "CredentialMetadata"("key");
CREATE UNIQUE INDEX "Project_path_key" ON "Project"("path");
CREATE INDEX "DailyMemory_date_idx" ON "DailyMemory"("date");
CREATE INDEX "Report_type_startDate_endDate_idx" ON "Report"("type", "startDate", "endDate");
